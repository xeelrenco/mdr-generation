...
class PipelineSummary:
    ...
    scope_pass2_pairs_verified: int = 0
    scope_pass2_pairs_final: int = 0
    scope_pass2_disagreements: int = 0
    scope_pass2_fallbacks: int = 0
    scope_pass2_strong_only: int = 0
    ...
    scope_stability_pairs_added: int = 0
    scope_stability_pairs_removed: int = 0
    scope_stability_candidate_delta: Optional[int] = None
